...
export const getSingleData = (
    ...
    return new Promise((resolve, reject) => {
        ...
        queryBuilder.exec((err, data) => {
            if (err || !data) {
                let response = helpers.showResponse(false, 'Retrieval failed', err);
                return resolve(response);
            }
            let response = helpers.showResponse(true, 'Data found', data);
            return resolve(response);
...
export const postData = (modalReference: any) => {
    return new Promise((resolve, reject) => {
...
export const updateData = (Model: any, DataObject: any, _id: string) => {
    return new Promise((resolve, reject) => {
...
export const updateSingleData = (Model: any, DataObject: any, matchObj: any) => {
    return new Promise((resolve, reject) => {
        Model.findOneAndUpdate(matchObj, { $set: DataObject }, { new: true }, (err: any, updatedData: any) => {
            if (err) {
                let response = helpers.showResponse(false, err);
                return resolve(response);
            }
...
export const updateOne = (Model: any, filter: any, update: any, options: any) => {
    return new Promise((resolve, reject) => {
        Model.findOneAndUpdate(filter, update, options)
            .exec()
            .then((data: any) => {
                if (!data) {
                    let response = helpers.showResponse(false, 'No data');
                    return resolve(response);
                }
...
export const updateByQuery = (Model: any, DataObject: any, filter: any) => {
    return new Promise((resolve, reject) => {
...
export const deleteData = (Model: any, query: any) => {
    return new Promise((resolve, reject) => {
...
export const deleteById = (Model: any, id: string) => {
    return new Promise((resolve, reject) => {
